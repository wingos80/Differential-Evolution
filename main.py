...
x = np.linspace(-20000,20000,2000)
y = np.linspace(-20000,20000,2000)
...
plt.figure()
plt.scatter(particles[:,0], particles[:,1], c='r',s=2,zorder=2)
plt.scatter(cg_x, cg_y, c='b',s=3,zorder=3, cmap='Blues')
